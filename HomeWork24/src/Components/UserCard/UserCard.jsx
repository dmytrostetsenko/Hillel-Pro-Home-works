...
export const UserCard = ({user}) => {
    ...
    const onUpdateUserSubmit = (name, email) => {
            ...
            {userState && 
                <div className="user">
                    <ul className="user__info">
                        ...
                        <li className='user__name'>{user.name ? user.name : currentUser.name}</li>
                        <li className='user__email'>{currentUser.email}</li>
                    </ul>
                    ...
                    <Modal active={modalActive} setActive={setModalActive}>
                        <UpdateUser setActive={setModalActive} currentUser={currentUser} setCurrentUser={setCurrentUser} setUserState={setUserState} onUpdateUserSubmit={onUpdateUserSubmit}/>
                    </Modal>
                </div>
            }
        </>
